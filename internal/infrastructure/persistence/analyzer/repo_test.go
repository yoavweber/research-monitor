...
func TestRepository_Upsert(t *testing.T) {
	t.Run("inserts a new analysis and round-trips via FindByID", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("overwrite preserves CreatedAt and advances UpdatedAt", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("concurrent reruns leave exactly one row", func(t *testing.T) {
		t.Parallel()
...
func TestRepository_FindByID(t *testing.T) {
	t.Run("returns ErrAnalysisNotFound for unknown id", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("wraps ErrCatalogueUnavailable when the DB is closed", func(t *testing.T) {
		t.Parallel()
