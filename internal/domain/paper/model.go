...
// It owns the Entry value object, the Query value object, the UseCase and
// Fetcher ports, and the upstream-failure error sentinels. It knows nothing
// about HTTP transport, XML/JSON wire formats, or any specific provider.
package paper
